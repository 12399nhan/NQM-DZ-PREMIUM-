...
Animation = "Scrpit NQM DZ Ver3"
},
Key = {
KeySystem = true
Title = "scrpit NQM DZ PREMIUM",
Description = "77497260558323",
KeyLink = "https://yeumoney.com/G9f4",
Keys = {"bcd0c02c45f0b05cd549609f1e794cca"},
Notifi = {
Notifications = true
CorrectKey = "Đang chạy menu NQM DZ Hub PREMIUM",
Incorrectkey = "Mật khẩu sai cho NQM hub yêu cầu get key lại!!!",
CopyKeyLink = "Copy link get key thành công"
}
}
})

MinimizeButton({
Image ="https://roblox.com/asset/?id=89284864928775",
Size = {40,40},
Color = Color3.fromRGB(10,1,010),
Corner = true
Stroke = false,
